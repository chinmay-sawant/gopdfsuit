module github.com/chinmay-sawant/gopdfsuit/v6
...
require (
	github.com/chinmay-sawant/gowkhtmltopdf v0.2.5
...
require (
	...
	github.com/tdewolff/canvas v0.0.0-20260803134256-8e86b9abb917 // indirect
