# Benchmark Comparison - 1.24 Optimization 5 vs 1.24 Optimization 4

This report compares the performance results of the **GoPdfSuit** API running on Go 1.24 (Optimization 5) against the previous best baseline (Optimization 4).

## Test Environment

- **Current Version:** Go 1.24 (Optimization 5 - Lock-free Font Registry & Reference Caching)
- **Previous Version:** Go 1.24 (Optimization 4 - Draw Loop & Font Scan Optimization)
- **Date:** 2026-02-14
- **CPU:** 13th Gen Intel(R) Core(TM) i7-13700HX (24 cores)

## Optimization Details (v1.24 Opt 5)
...
| Metric             | v1.24 (Opt 4) | v1.24 (Opt 5)   | Change              |
| :----------------- | :------------ | :-------------- | :------------------ |
