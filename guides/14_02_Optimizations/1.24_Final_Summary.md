...
| Metric          | v1.24 Optimized (Baseline) | v1.24 Opt 6 (100 VUs) | v1.24 Opt 7 (48 VUs) | Improvement (Opt 7 vs Opt 6) |
| :-------------- | :------------------------- | :-------------------- | :------------------- | :--------------------------- |
| **Throughput**  | 78.64 req/s                | 82.79 req/s           | **320.71 req/s**     | **+287% (3.9x Faster)**      |
| **Avg Latency** | 35.39 ms                   | 10.67 ms              | 59.45 ms             | +457% (Due to higher load)   |
| **p95 Latency** | 324.49 ms                  | 73.77 ms              | 212.59 ms            | +188% (Due to higher load)   |
| **p99 Latency** | 575.54 ms                  | 115.99 ms             | 693.14 ms            | +497% (Due to higher load)   |

> **Conclusion:** Reducing the VUs from 100 to 48 (matching the CPU core count/concurrency limit) significantly unlocked the system's throughput, jumping from **~83 req/s to ~321 req/s**. The previous 100 VU test likely suffered from excessive context switching or contention. While latency increased, this is a trade-off for the massive 4x gain in request processing capacity.
