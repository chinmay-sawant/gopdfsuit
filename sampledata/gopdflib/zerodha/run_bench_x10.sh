...
echo "Output: $OUT"
echo "Cache override example: GOCACHE=/tmp/gopdfsuit-go-build-cache GOMODCACHE=/tmp/gopdfsuit-go-mod-cache make bench-gopdflib-zerodha-x10"
...
STATS="$REPO_ROOT/guides/cursor/baselines/zerodha_bench_x10_wsl_stats_latest.txt"
